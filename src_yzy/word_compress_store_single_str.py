def write_index_single_str(file_path, inverted_index):  #需要分开存储词典和倒排表项
    # maxlen = 0
    # word = ""
    ...
    file1 = open(file_path + "_basic_store_dict.binery_single", "wb")
    file2 = open(file_path + "_basic_store_index.binery_single", "wb")
    total_str = ""
